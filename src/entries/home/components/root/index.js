...
export default class Root extends PureComponent {
    ...
    componentDidMount() {
        ...
        setTimeout(() => {
            ...
            document
                ...
                .style
                .minHeight = minH - th + "px";
            let AcSliderW = document
                .getElementById("articleSlider")
                .clientWidth;
            let AcImgH = AcSliderW * 168 / 294;
            let AcSliderH = AcSliderW * 348 / 294;
            this.setState({AcImgH: AcImgH, AcSliderH: AcSliderH});
        }, 0);

        // document.getElementById("homeBoxArticleImg").style.maxHeight = 	AcImgH +
        // "px";
        this.setArticleList();
        this.setNewsList(1);
        this.setProjectList();
    ...
    setArticleList(page) {
        this
            .props
            .getArticleList({type: "[2,3,4]", is_scroll: true});
    }
    setNewsList(page) {
        this
            .props
            .getNewsList({type: "[1]", per_page: 4, page: page});
    }
    setProjectList(page) {
        this
            .props
            .getProject({per_page: 10, home_article: true});
    }
    ...
    openAnnobox(item) {
        this.setState({showAnno: true, annoItem: item});
    }
    closeAnnobox() {
        this.setState({showAnno: false, annoItem: null});
    }
    turnToCandy() {
        if (IsTouchDevice) {
    ...
    render() {
        ...
        const settings1 = {
            ...
            adaptiveHeight: true,
            afterChange: function (index) {
                this.setState({sliderIndex1: index});
            }.bind(this)
        };
        const settings2 = {
            // dots: true,
            ...
            adaptiveHeight: true,
            afterChange: function (index) {
                this.setState({sliderIndex2: index});
            }.bind(this)
        };
        return (
            <I18n>
                            ...
                            <div id="homeBox" className="homeBox ui f1 m-home-mainBox">
                                <div className="homeBoxList homeBoxArticle">
                                    <div className="homeBoxArticleTop">
                                        <div id="articleSlider" className="articleSlider">
                                            {articleList && articleList.data && articleList.data.length > 0 && (
                                        ...
                                        <div className="homeBoxArticleBtn">
                                            {articleList.data && articleList.data.length - 1 !== sliderIndex && (
                                                <span
                                            ...
                                            {articleList.data && sliderIndex == articleList.data.length - 1 && (
                                    ...
                                    <div className="homeBoxArticleBottom homeBoxList homeBoxCandy">
                                        {!IsTouchDevice && (
                                            <div
                                                className={ads.data && ads.data.length == 1
                                                ? "homeInweWallet one ui"
                                                : "homeInweWallet ui"}>
                                                {ads.data && ads.data.length > 1 && sliderIndex1 !== 0 && (
                                                ...
                                                <div className="homeInweWalletUl f1 ui center">
                                                    <div
                                                        ...
                                                        {ads.data && ads.data.length > 0 && (
                                                            <Slider ref={c => (this.slider1 = c)} {...settings1}>
                                                                {ads
                                                                    .data
                                                                    .map((item, index) => {
                                                                        return (
                                                ...
                                                {ads.data && ads.data.length > 1 && ads.data.length - 1 !== sliderIndex1 && (
                                ...
                                <div className="homeRight ui f1">
                                    <div className="homeRightTop ui f1">
                                        <div className="homeBoxList homeBoxNews homeBoxPro">
                                            <div className="homeBoxNewsAll">
                                                ...
                                                <ul className="homeBoxNewsUl">
                                                    {project && project.data && project.data.length > 0 && project
                                                        .data
                                                        .map((item, index) => {
                                                            return (
                                                                <li key={index}>
                                                                    <Link
                                                                        ...
                                                                        to={{
                                                                        pathname: "/newsdetail",
                                                                        search: item.last_article && "?art_id=" + item.last_article.id
                                                                    }}
                                                                        title={item.last_article && item.last_article.title}>
                                                                        <img
                                                                            src={item.img}
                                                                            alt=""
                                                                            onClick={e => {
                                                                            e.preventDefault();
                                                                            this.turnToPro(item.id);
                                                                        }}/>
                                                                        <p>
                                                                            {item.last_article && item.last_article.title}
                                                                        </p>
                                                                    </Link>
                                                                </li>
                                                            );
                                            ...
                                            <div className="homeBoxNewsBottom">
                                                <div className="homeBoxAnnoTop">
                                                    ...
                                                    <div className="homeBoxAnnoList">
                                                        {exchangeNotice && exchangeNotice.data && exchangeNotice.data.length > 0 && exchangeNotice
                                                            .data
                                                            .map((item, index) => {
                                                                return (
                                                                    <p
                                        ...
                                        <div
                                            ...
                                            <div className="homeBoxCandyTop">
                                                ...
                                                <div className="homeBoxCandyTopAll">
                                                    ...
                                                    {candyList.list && candyList.list.data && candyList.list.data.length > 0 && candyList
                                                        .list
                                                        .data
                                                        .map((item, index) => {
                                                            return (
                                                                <Link
                                                                    ...
                                                                    <span key={index} className="homeCandySpan">
                                                                        +{item.name
}
                                                                    </span>
                                                                </Link>
                                                    ...
                                                    {candyList && candyList.list && candyList.list.data && candyList.list.data.length == 0 && (
                                        ...
                                        <div className="homeBoxList homeBoxAnno homeBoxAnnoAll">
                                            {!IsTouchDevice && userFavo && userFavo.data && userFavo.data.length > 0 && (
                                                <div className="homeBoxFllow">
                                                    ...
                                                    <div className="homeBoxReadMore">
                                                        <Link
                                                            ...
                                                            e.preventDefault();
                                                            if (userInfo) {
                                                                window.location.href = "/member?type=collection";
                                                            } else {
                                                                window
                                                                    .headerBox
                                    ...
                                    <div className="homeRightBottom">
                                        <div
                                            ...
                                            {ads2 && ads2.data && ads2.data.length > 0 && (
                                        ...
                                        <div className="ads2Arrow">
                                            ...
                                            {ads2.data && ads2.data.length > 1 && ads2.data.length - 1 !== sliderIndex2 && (<span
                                            ...
                                            {ads2.data && ads2.data.length > 1 && ads2.data.length - 1 == sliderIndex2 && (<span className="rtArrow"/>)}
                                            {ads2.data && ads2.data.length > 1 && sliderIndex2 !== 0 && (<span
                                            ...
                                            {ads2.data && ads2.data.length > 1 && sliderIndex2 == 0 && (<span className="lfArrow"/>)}
                                        </div>
                                    </div>
                                </div>
                                {IsTouchDevice && (
